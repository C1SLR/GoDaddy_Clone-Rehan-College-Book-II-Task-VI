            ...
            {items.length === 0 ? (
              <div className="text-center py-24 bg-white rounded-3xl shadow-sm border border-gray-100 flex flex-col items-center">
                ...
                <p className="text-gray-500 mb-10 max-w-xs mx-auto">
                  Looks like you haven't added any domains yet. Let's find you
                  the perfect one!
                </p>
                <Button
              ...
              <div className="space-y-6">
                {items.map((item) => (
                  <Card
                    key={item.id}
                    className="border border-gray-100 shadow-sm hover:shadow-md transition-shadow rounded-2xl bg-white overflow-hidden"
                  >
          ...
          <div className="w-full lg:w-[400px]">
            <Card className="border border-gray-100 shadow-xl rounded-3xl sticky top-24 bg-white overflow-hidden">
              <Card.Content className="p-10">
                <h2 className="text-2xl font-black mb-8 text-[#00838C]">
                  Order Summary
                </h2>
                ...
                <div className="flex justify-between items-baseline mb-10">
                  <span className="text-black font-black text-xl uppercase tracking-tight">
                    Total
                  </span>
